from jsonplaceholder_api.settings import *

from jsonplaceholder_api.endpoints import jsonplaceholder_api
from jsonplaceholder_api.utils.assertions import Assertions
from jsonplaceholder_api.payloads.payloads import *
